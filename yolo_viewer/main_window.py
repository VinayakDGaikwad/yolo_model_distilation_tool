...
class MainWindow(QMainWindow):
    ...
    def _init_ui(self):
        ...
        vDraw.addLayout(hD1)
        hD2 = QHBoxLayout()
        self.btn_draw = QPushButton("✏️ Draw Circle (D)")
        self.btn_draw.setCheckable(True)
        self.btn_draw.setStyleSheet("QPushButton:checked { background: #ffcccc; font-weight: bold; }")
        self.btn_draw.setToolTip("Toggle draw mode - click-drag on image to draw a circle and matching square box.")
        ...
        vDraw.addLayout(hD2)
        hD2b = QHBoxLayout()
        hD2b.addWidget(QLabel("Circle diameter (px):"))
        self.spin_circle_diameter = QSpinBox()
        self.spin_circle_diameter.setRange(5, 2000)
        self.spin_circle_diameter.setValue(50)
        self.spin_circle_diameter.setFixedWidth(80)
        self.spin_circle_diameter.setToolTip("Fixed diameter used for each click in Draw Circle mode")
        hD2b.addWidget(self.spin_circle_diameter)
        hD2b.addStretch()
        vDraw.addLayout(hD2b)
    ...
    def _connect(self):
        ...
        self.spin_circle_diameter.valueChanged.connect(self.scene.set_circle_diameter)
